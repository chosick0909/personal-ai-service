...
function CreatorWorkspace() {
  ...
  return <main className="creator-tools ct-live" data-theme={theme}>
    ...
    <form onSubmit={submit} className="ct-form">
      ...
      {mode==='reference-accounts' && <p className="ct-muted">공개 개인 크리에이터의 주제, 전달 방식, 최근 활동을 비교해 내 콘텐츠 방향을 살펴봅니다. 개인 크리에이터 여부, 선택한 팔로워 범위, 수집된 공개 게시물 중 조회수 50만 이상 콘텐츠 보유 여부는 필수 조건입니다.</p>}
